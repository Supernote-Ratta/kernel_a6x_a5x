...
/*  Timeout in ms */
// 20190324: timeout 一般是由于没有挂TP，比如产线SMT做主板升级的时候。
// 这种情况下不需要太长的TIMEOUT 定义。--20211109: 为了解决概率性无触摸的问题，加大这些延迟.
#define CY_REQUEST_EXCLUSIVE_TIMEOUT	5000 //	8000
#define CY_WATCHDOG_TIMEOUT				1000
#define CY_HID_RESET_TIMEOUT			3000 ///5000
#define CY_HID_AUTO_CALI_CPLT_TIMEOUT   2000 // 2500


/* HID_DESCRIPTOR_TIMEOUT value based on FW spec (CAL_OS) */
// 20180922: 当把TP的I2C拔掉的时候，休眠唤醒会很慢。主要就是这个初始化失败timeout
// 时间太长：4000 ms。
#define CY_HID_GET_HID_DESCRIPTOR_TIMEOUT	3000// 4000
...
struct cyttsp5_core_data {
	...
	//20180704,input is temply disabled.
	bool tch_disabled;
    //bool input_before_disabled;
	...
	// 20210630,hsl add.
	struct delayed_work 	cover_det_work;
	int 					i2c_err_cnt;  // 20210806: hsl add.
